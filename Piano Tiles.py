...
def show_endScreen():
    ...
    drawTextCent(
        "YOUR SCORE: " + str(score), "arial", 50, BLACK, sWidth / 2, sHeight * 0.5
    )
    drawTextCent(
        "Press the 'n' key to begin a new game",
        "arial",
        30,
        BLACK,
        sWidth / 2,
...
def playNote(song, chord, index1, index2=0, index3=0):
